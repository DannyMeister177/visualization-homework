...
plt.ylabel('Charges $')
plt.savefig(f'plots/charges_plot_wLabels.png', format='png')
plt.clf()
...
plt.xlabel('BMI')
plt.ylabel('Count')
plt.savefig(f'plots/bmi_hist_wLabels.png', format='png')
plt.clf()
...
plt.xlabel('Age')
plt.ylabel('Charges $')
plt.savefig(f'plots/age_to_charges_wLabels.png', format='png')
